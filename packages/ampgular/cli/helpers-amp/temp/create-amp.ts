...
import { embedScripts, customFunctions } from './frame-custom';
...
import { staticConfig, ampConfig } from './settings/amp-routes';
...
if (ampConfig['ampValidation'])
{ await validateAMP(myAMPHtml,route) }
